#!/usr/bin/env python3
"""Build the itsfs documentation site from the Markdown the repo already carries.

Nothing is duplicated: the sources are README.md, HANDOFF.md, PLAN.md and docs/*.md, rendered rather
...
HEADER_LOGO = "assets/logo-itsfs.svg"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the itsfs docs site.")
    ...
    NAV = [("overview", "Overview"), ("design", "Design"), ("roadmap", "Roadmap")]
    ...
    hero_primary = href_from(output_dir / "index.html", "overview")
