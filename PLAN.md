...
| **8** | native-tool interop: `NSALV`, then the monitor | ITS mounts and reads what we wrote | **done: NSALV, DSKDMP, a boot, a pack built from nothing, and the monitor printing a file we wrote** |
